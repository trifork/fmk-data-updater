...
var ShortTextConverterImpl = /** @class */ (function () {
...
var DosageWrapper = /** @class */ (function () {
...
var LongTextConverterImpl = /** @class */ (function () {
    function LongTextConverterImpl() {
    }
    LongTextConverterImpl.prototype.appendSupplText = function (structure, s) {
        if (structure.getSupplText()) {
            s += ".\n" + __WEBPACK_IMPORTED_MODULE_2__TextHelper__["a" /* TextHelper */].INDENT + "Bemærk: " + structure.getSupplText();
        }
        return s;
    };
    ...
    LongTextConverterImpl.prototype.makeDaysDosage = function (unitOrUnits, structure, day, hasDaysLabel) {
        ...
        if (day.getNumberOfDoses() === 1) {
            ...
            s += this.makeOneDose(day.getDose(0), unitOrUnits);
            if (day.containsAccordingToNeedDosesOnly() && day.getDayNumber() > 0) {
                s += " højst " + day.getNumberOfDoses() + " " + __WEBPACK_IMPORTED_MODULE_2__TextHelper__["a" /* TextHelper */].gange(day.getNumberOfDoses()) + daglig;
            }
            else {
                s += " " + day.getNumberOfDoses() + " " + __WEBPACK_IMPORTED_MODULE_2__TextHelper__["a" /* TextHelper */].gange(day.getNumberOfDoses()) + daglig;
            }
        }
    ...
    LongTextConverterImpl.prototype.makeOneDose = function (dose, unitOrUnits) {
...
var DoseWrapper = /** @class */ (function () {
...
var DosisTilTekstException = /** @class */ (function () {
...
var DateOrDateTimeWrapper = /** @class */ (function () {
...
var StructuresWrapper = /** @class */ (function () {
...
var ShortTextConverter = /** @class */ (function () {
    /**
    ...
    ShortTextConverter.prototype.getConverterClassName = function (dosageJson, maxLength) {
        if (maxLength === void 0) { maxLength = ShortTextConverter.MAX_LENGTH; }
        return this.getConverterClassNameWrapper(__WEBPACK_IMPORTED_MODULE_19__vowrapper_DosageWrapper__["a" /* DosageWrapper */].fromJsonObject(dosageJson), maxLength);
    };
    ...
    ShortTextConverter.prototype.getConverterClassNameWrapper = function (dosage, maxLength) {
        if (maxLength === void 0) { maxLength = ShortTextConverter.MAX_LENGTH; }
    ...
    ShortTextConverter.prototype.convertStr = function (jsonStr, maxLength) {
        if (maxLength === void 0) { maxLength = ShortTextConverter.MAX_LENGTH; }
        if (jsonStr === undefined || jsonStr === null) {
            return null;
        }
...
var MorningNoonEveningNightConverterImpl = /** @class */ (function (_super) {
...
var LongTextConverter = /** @class */ (function () {
...
var WeeklyRepeatedConverterImpl = /** @class */ (function (_super) {
...
var StructureWrapper = /** @class */ (function () {
    ...
    StructureWrapper.prototype.setSupplText = function (st) {
        this.supplText = st;
    };
...
var XML140Generator = /** @class */ (function (_super) {
    ...
    XML140Generator.prototype.generateCommonXml = function (iteration, mapping, unitTextSingular, unitTextPlural, supplementaryText, beginDate, endDate) {
        ...
        if (endDate) {
            xml += "<m12:EndDate>" + __WEBPACK_IMPORTED_MODULE_1__TextHelper__["a" /* TextHelper */].formatYYYYMMDD(endDate) + "</m12:EndDate>";
        }
        else {
...
var XML142Generator = /** @class */ (function (_super) {
    ...
    XML142Generator.prototype.generateCommonXml = function (iteration, mapping, unitTextSingular, unitTextPlural, supplementaryText, beginDate, endDate) {
        ...
        if (endDate) {
            xml += "<" + this.getNamespace() + ":EndDate>" + __WEBPACK_IMPORTED_MODULE_2__TextHelper__["a" /* TextHelper */].formatYYYYMMDD(endDate) + "</" + this.getNamespace() + ":EndDate>";
        }
        else {
...
var XML144Generator = /** @class */ (function (_super) {
...
var SimpleLongTextConverterImpl = /** @class */ (function (_super) {
 ...
 */
var SimpleLimitedAccordingToNeedConverterImpl = /** @class */ (function (_super) {
...
var EveningDoseWrapper = /** @class */ (function (_super) {
...
var FreeTextWrapper = /** @class */ (function () {
...
var MorningDoseWrapper = /** @class */ (function (_super) {
...
var NightDoseWrapper = /** @class */ (function (_super) {
...
var NoonDoseWrapper = /** @class */ (function (_super) {
...
var PlainDoseWrapper = /** @class */ (function (_super) {
...
var UnitOrUnitsWrapper = /** @class */ (function () {
 ...
 */
var DailyDosisCalculator = /** @class */ (function () {
...
var DosagePeriod = /** @class */ (function () {
...
var DosageProposalXML = /** @class */ (function () {
...
var XML146Generator = /** @class */ (function (_super) {
...
var DosageTypeCalculator = /** @class */ (function () {
...
var AdministrationAccordingToSchemaConverterImpl = /** @class */ (function (_super) {
...
var DailyRepeatedConverterImpl = /** @class */ (function (_super) {
...
var DefaultLongTextConverterImpl = /** @class */ (function (_super) {
...
var DefaultMultiPeriodeLongTextConverterImpl = /** @class */ (function (_super) {
...
var EmptyStructureConverterImpl = /** @class */ (function (_super) {
...
var FreeTextConverterImpl = /** @class */ (function (_super) {
...
var TwoDaysRepeatedConverterImpl = /** @class */ (function (_super) {
...
var MorningNoonEveningNightAndAccordingToNeedConverterImpl = /** @class */ (function (_super) {
...
var MorningNoonEveningNightEyeOrEarConverterImpl = /** @class */ (function (_super) {
...
var WeeklyMorningNoonEveningNightConverterImpl = /** @class */ (function (_super) {
...
var AdministrationAccordingToSchemaWrapper = /** @class */ (function () {
...
var TimedDoseWrapper = /** @class */ (function (_super) {
...
var AbstractXMLGenerator = /** @class */ (function () {
...
var CombinedTextConverter = /** @class */ (function () {
...
var DosageProposalXMLGenerator = /** @class */ (function () {
    ...
    DosageProposalXMLGenerator.generateXMLSnippet = function (type, iteration, mapping, unitTextSingular, unitTextPlural, supplementaryText, beginDates, endDates, fmkversion, dosageProposalVersion, shortTextMaxLength) {
        if (shortTextMaxLength === void 0) { shortTextMaxLength = __WEBPACK_IMPORTED_MODULE_6__ShortTextConverter__["a" /* ShortTextConverter */].MAX_LENGTH; }
        ...
        return new __WEBPACK_IMPORTED_MODULE_0__DosageProposalXML__["a" /* DosageProposalXML */](xml, __WEBPACK_IMPORTED_MODULE_6__ShortTextConverter__["a" /* ShortTextConverter */].getInstance().convertWrapper(dosageWrapper, shortTextMaxLength), __WEBPACK_IMPORTED_MODULE_7__LongTextConverter__["a" /* LongTextConverter */].getInstance().convertWrapper(dosageWrapper));
    };
 ...
 *
 */
var DosageTypeCalculator144 = /** @class */ (function () {
    ...
    DosageTypeCalculator144.daysBetween = function (startDate, endDate) {
        ...
        var d1 = DosageTypeCalculator144.treatAsUTC(endDate);
        var d2 = DosageTypeCalculator144.treatAsUTC(startDate);
        d1.setUTCHours(0);
        d2.setUTCHours(0);
...
var CombinedConversion = /** @class */ (function () {
...
var MMANMapping = /** @class */ (function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__TextHelper__ = __webpack_require__(0);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var CombinedTwoPeriodesConverterImpl = /** @class */ (function (_super) {
    ...
    CombinedTwoPeriodesConverterImpl.prototype.doConvert = function (dosage) {
        ...
        var tempSupplText = tempStructure.getSupplText();
        ...
        var tempText = new __WEBPACK_IMPORTED_MODULE_1__ShortTextConverter__["a" /* ShortTextConverter */]().convertWrapper(tempDosage, 10000); // 10000 to avoid anything longer than 70 chars being cut
        ...
        var fixedSupplText = fixedStructure.getSupplText();
        ...
        var fixedText = new __WEBPACK_IMPORTED_MODULE_1__ShortTextConverter__["a" /* ShortTextConverter */]().convertWrapper(fixedDosage, 10000); // 10000 to avoid anything longer than 70 chars being cut
        fixedStructure.setSupplText(fixedSupplText);
        var supplText = "";
        if (tempStructure.getSupplText())
            supplText += __WEBPACK_IMPORTED_MODULE_4__TextHelper__["a" /* TextHelper */].maybeAddSpace(tempStructure.getSupplText()) + tempStructure.getSupplText();
        if (fixedStructure.getSupplText() && tempStructure.getSupplText() !== fixedStructure.getSupplText())
            supplText += __WEBPACK_IMPORTED_MODULE_4__TextHelper__["a" /* TextHelper */].maybeAddSpace(fixedStructure.getSupplText()) + fixedStructure.getSupplText();
...
var DayInWeekConverterImpl = /** @class */ (function (_super) {
 ...
 */
var LimitedNumberOfDaysConverterImpl = /** @class */ (function (_super) {
 ...
 */
var MorningNoonEveningNightInNDaysConverterImpl = /** @class */ (function (_super) {
...
var MultipleDaysNonRepeatedConverterImpl = /** @class */ (function (_super) {
    ...
    MultipleDaysNonRepeatedConverterImpl.prototype.doConvert = function (dosage) {
        ...
        if (structure.containsMorningNoonEveningNightDoses()) {
            ...
            text += __WEBPACK_IMPORTED_MODULE_2__MorningNoonEveningNightConverterImpl__["a" /* MorningNoonEveningNightConverterImpl */].getNoonText(firstDay, dosage.structures.getUnitOrUnits());
            text += __WEBPACK_IMPORTED_MODULE_2__MorningNoonEveningNightConverterImpl__["a" /* MorningNoonEveningNightConverterImpl */].getEveningText(firstDay, dosage.structures.getUnitOrUnits());
            text += __WEBPACK_IMPORTED_MODULE_2__MorningNoonEveningNightConverterImpl__["a" /* MorningNoonEveningNightConverterImpl */].getNightText(firstDay, dosage.structures.getUnitOrUnits());
        }
        else {
...
var NumberOfWholeWeeksConverterImpl = /** @class */ (function (_super) {
...
var ParacetamolConverterImpl = /** @class */ (function (_super) {
...
var RepeatedConverterImpl = /** @class */ (function (_super) {
...
var RepeatedEyeOrEarConverterImpl = /** @class */ (function (_super) {
    ...
    RepeatedEyeOrEarConverterImpl.prototype.doConvert = function (dosage) {
        ...
        var supplText = "";
        if (__WEBPACK_IMPORTED_MODULE_1__TextHelper__["a" /* TextHelper */].strEndsWith(structure.getSupplText(), "i hvert øje")) {
            supplText = __WEBPACK_IMPORTED_MODULE_1__TextHelper__["a" /* TextHelper */].maybeAddSpace("i begge øjne") + "i begge øjne";
        }
        else if (__WEBPACK_IMPORTED_MODULE_1__TextHelper__["a" /* TextHelper */].strEndsWith(structure.getSupplText(), "i hvert øre")) {
            supplText = __WEBPACK_IMPORTED_MODULE_1__TextHelper__["a" /* TextHelper */].maybeAddSpace("i begge ører") + "i begge ører";
        }
        else if (__WEBPACK_IMPORTED_MODULE_1__TextHelper__["a" /* TextHelper */].strEndsWith(structure.getSupplText(), "i hvert næsebor")) {
            supplText = __WEBPACK_IMPORTED_MODULE_1__TextHelper__["a" /* TextHelper */].maybeAddSpace("i begge næsebor") + "i begge næsebor";
        }
        text += supplText;
        return text;
    };
 ...
 * 2: 2 stk efter behov
 */
var SimpleAccordingToNeedConverterImpl = /** @class */ (function (_super) {
 ...
 */
var SimpleNonRepeatedConverterImpl = /** @class */ (function (_super) {
