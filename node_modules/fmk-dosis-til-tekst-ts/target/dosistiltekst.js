...
var TextHelper = /** @class */ (function () {
    ...
    TextHelper.addShortSupplText = function (supplText) {
        return ".\nBemærk: " + supplText;
    };
...
var MorningNoonEveningNightConverterImpl = /** @class */ (function (_super) {
    ...
    MorningNoonEveningNightConverterImpl.getSupplText = function (supplText) {
        if (supplText) {
            return __WEBPACK_IMPORTED_MODULE_1__TextHelper__["a" /* TextHelper */].addShortSupplText(supplText);
        }
        return "";
    };
...
var SimpleLimitedAccordingToNeedConverterImpl = /** @class */ (function (_super) {
    ...
    SimpleLimitedAccordingToNeedConverterImpl.prototype.doConvert = function (dosage) {
        ...
        if (structure.getSupplText())
            text += __WEBPACK_IMPORTED_MODULE_1__TextHelper__["a" /* TextHelper */].addShortSupplText(structure.getSupplText());
...
var MorningNoonEveningNightAndAccordingToNeedConverterImpl = /** @class */ (function (_super) {
    ...
    MorningNoonEveningNightAndAccordingToNeedConverterImpl.getSupplText = function (supplText) {
        var text = "";
        if (supplText)
            text += __WEBPACK_IMPORTED_MODULE_2__TextHelper__["a" /* TextHelper */].addShortSupplText(supplText);
        return text;
    };
...
var WeeklyRepeatedConverterImpl = /** @class */ (function (_super) {
    ...
    WeeklyRepeatedConverterImpl.prototype.doConvert = function (dosage) {
        ...
        text += " hver uge";
        if (structure.getSupplText())
            text += __WEBPACK_IMPORTED_MODULE_2__TextHelper__["a" /* TextHelper */].addShortSupplText(structure.getSupplText());
        return text.toString();
    };
...
var CombinedTwoPeriodesConverterImpl = /** @class */ (function (_super) {
    ...
    CombinedTwoPeriodesConverterImpl.prototype.doConvert = function (dosage) {
        ...
        if (tempStructure.getSupplText())
            supplText += __WEBPACK_IMPORTED_MODULE_4__TextHelper__["a" /* TextHelper */].addShortSupplText(tempStructure.getSupplText());
        if (fixedStructure.getSupplText() && tempStructure.getSupplText() !== fixedStructure.getSupplText())
            supplText += __WEBPACK_IMPORTED_MODULE_4__TextHelper__["a" /* TextHelper */].addShortSupplText(fixedStructure.getSupplText());
...
var RepeatedEyeOrEarConverterImpl = /** @class */ (function (_super) {
    ...
    RepeatedEyeOrEarConverterImpl.prototype.doConvert = function (dosage) {
        ...
        var supplText = "";
        if (__WEBPACK_IMPORTED_MODULE_1__TextHelper__["a" /* TextHelper */].strEndsWith(structure.getSupplText(), "i hvert øje")) {
            supplText = __WEBPACK_IMPORTED_MODULE_1__TextHelper__["a" /* TextHelper */].addShortSupplText("i begge øjne");
        }
        else if (__WEBPACK_IMPORTED_MODULE_1__TextHelper__["a" /* TextHelper */].strEndsWith(structure.getSupplText(), "i hvert øre")) {
            supplText = __WEBPACK_IMPORTED_MODULE_1__TextHelper__["a" /* TextHelper */].addShortSupplText("i begge ører");
        }
        else if (__WEBPACK_IMPORTED_MODULE_1__TextHelper__["a" /* TextHelper */].strEndsWith(structure.getSupplText(), "i hvert næsebor")) {
            supplText = __WEBPACK_IMPORTED_MODULE_1__TextHelper__["a" /* TextHelper */].addShortSupplText("i begge næsebor");
        }
        text += supplText;
        return text;
    };
